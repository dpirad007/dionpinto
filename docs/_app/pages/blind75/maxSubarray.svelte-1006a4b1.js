import{S as ha,i as ua,s as da,e as a,k as s,t as i,w as H,c as n,a as r,m as c,h as l,d as e,x as L,b as h,f as ma,g as kt,J as t,y as M,E as fa,q as R,o as W,B as V}from"../../chunks/index-cd4245c1.js";import{b as pa}from"../../chunks/paths-c8fbcc1d.js";import{S as va,N as ya,F as _a}from"../../chunks/Footer-8b9c5841.js";import{T as At}from"../../chunks/Title-6ea0487f.js";/* empty css                           */function ga(ca){let f,et,Tt,at,Ct,nt,Ot,_t,S,gt,_,rt,P,It,m,E,k,Bt,ot,Nt,jt,q,Ht,Lt,g,it,F,Mt,Rt,lt,J,Wt,Vt,st,G,qt,Ft,b,A,Jt,U,Gt,$,Ut,zt,u,D,Kt,ct,Qt,Xt,z,T,Yt,Be=`
	class Solution:
    ...
    class Solution:
        def maxSubArray(self, nums: List[int]) -> int:
            ...
            return maxval
				`,we,Se,Pe,pt,ke,Ae,vt,De,Te,x,Ce,Oe,yt,j,Et;return S=new va({}),P=new ya({props:{curPage:"Blog"}}),k=new At({props:{type:2,title:Dt}}),A=new At({props:{type:5,title:"Description"}}),D=new At({props:{type:5,title:"Explanation"}}),B=new At({props:{type:5,title:"Code (Python)"}}),j=new _a({}),{c(){f=a("head"),et=a("meta"),Tt=s(),at=a("meta"),Ct=s(),nt=a("title"),Ot=i(Dt),_t=s(),H(S.$$.fragment),gt=s(),_=a("main"),rt=a("header"),H(P.$$.fragment),It=s(),m=a("main"),E=a("div"),H(k.$$.fragment),Bt=s(),ot=a("h4"),Nt=i("Leetcode Blind 75"),jt=s(),q=a("h5"),Ht=i("19th July 2022 ~ Dion Pinto"),Lt=s(),g=a("div"),it=a("div"),F=a("a"),Mt=i("Description"),Rt=s(),lt=a("div"),J=a("a"),Wt=i("Explanation"),Vt=s(),st=a("div"),G=a("a"),qt=i("Code"),Ft=s(),b=a("section"),H(A.$$.fragment),Jt=s(),U=a("p"),Gt=i(`Given an integer array nums, find the contiguous subarray (containing at least one number)
			...
			`),ge=s(),ft=a("p"),Ee=i(`Suppose we get the above scenario where all the numbers are negative, then we just need to
				...
				`),we=i(He),Se=i(`			
			`),Pe=s(),pt=a("p"),ke=i("Time Complexity => o(n)"),Ae=s(),vt=a("p"),De=i("Space Complexity => o(1)"),Te=s(),x=a("a"),Ce=i("Back"),Oe=s(),yt=a("footer"),H(j.$$.fragment),this.h()},l(o){f=n(o,"HEAD",{});var v=r(f);et=n(v,"META",{name:!0,content:!0}),Tt=c(v),at=n(v,"META",{name:!0,content:!0}),Ct=c(v),nt=n(v,"TITLE",{});var Le=r(nt);Ot=l(Le,Dt),Le.forEach(e),v.forEach(e),_t=c(o),L(S.$$.fragment,o),gt=c(o),_=n(o,"MAIN",{class:!0});var Y=r(_);rt=n(Y,"HEADER",{});var Me=r(rt);L(P.$$.fragment,Me),Me.forEach(e),It=c(Y),m=n(Y,"MAIN",{class:!0});var y=r(m);E=n(y,"DIV",{id:!0});var Z=r(E);L(k.$$.fragment,Z),Bt=c(Z),ot=n(Z,"H4",{});var Re=r(ot);Nt=l(Re,"Leetcode Blind 75"),Re.forEach(e),jt=c(Z),q=n(Z,"H5",{style:!0});var We=r(q);Ht=l(We,"19th July 2022 ~ Dion Pinto"),We.forEach(e),Z.forEach(e),Lt=c(y),g=n(y,"DIV",{id:!0,class:!0});var tt=r(g);it=n(tt,"DIV",{});var Ve=r(it);F=n(Ve,"A",{href:!0});var qe=r(F);Mt=l(qe,"Description"),qe.forEach(e),Ve.forEach(e),Rt=c(tt),lt=n(tt,"DIV",{});var Fe=r(lt);J=n(Fe,"A",{href:!0});var Je=r(J);Wt=l(Je,"Explanation"),Je.forEach(e),Fe.forEach(e),Vt=c(tt),st=n(tt,"DIV",{});var Ge=r(st);G=n(Ge,"A",{href:!0});var Ue=r(G);qt=l(Ue,"Code"),Ue.forEach(e),Ge.forEach(e),tt.forEach(e),Ft=c(y),b=n(y,"SECTION",{id:!0});var bt=r(b);L(A.$$.fragment,bt),Jt=c(bt),U=n(bt,"P",{});var Ie=r(U);Gt=l(Ie,`Given an integer array nums, find the contiguous subarray (containing at least one number)
				which has the largest sum and return its sum. A subarray is a contiguous part of an array.
