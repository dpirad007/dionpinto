import{S as cs,i as hs,s as ds,w as v,k as i,e as s,t as c,x as y,m as o,c as n,a as r,d as a,h,b as e,f as qt,y as b,g as os,J as t,E as ms,q as $,o as _,B as E}from"../chunks/index-cd4245c1.js";import{S as us,N as ps,F as ws}from"../chunks/Footer-9c2a65ce.js";import{T as O}from"../chunks/Title-6ea0487f.js";import"../chunks/paths-c8fbcc1d.js";function fs(ls){let D,Bt,z,ht,J,Ut,d,k,C,Xt,Mt,Yt,Zt,dt,te,ee,m,Nt,H,ae,se,xt,V,ne,re,Ft,j,ie,oe,Jt,q,le,ce,Ct,B,he,de,Ht,L,me,ue,Vt,G,pe,we,jt,K,fe,ge,T,Q,ve,mt,ye,be,R,U,$e,ut,_e,Ee,pt,ze,Re,A,X,Ae,wt,Se,Ie,ft,ke,We,S,Y,Pe,gt,De,Te,vt,Oe,Me,w,Z,Ne,yt,xe,Fe,bt,Je,Ce,$t,He,Ve,_t,je,qe,I,tt,Be,Et,Le,Ge,zt,Ke,Qe,f,et,Ue,Rt,Xe,Ye,at,At,Ze,M,ta,ea,st,nt,aa,va=`
  ...
  | 5     | 1.2    | na     |
  +-------+--------+--------+
				`,ua,pa,wa,kt,ct,Lt;return D=new us({}),J=new ps({props:{curPage:"Blog"}}),C=new O({props:{type:2,title:"Entropy"}}),Q=new O({props:{type:5,title:"Introduction"}}),U=new O({props:{type:5,title:"What is ml-wasm/entropy"}}),X=new O({props:{type:5,title:"Why Ndarray?"}}),Y=new O({props:{type:5,title:"What is wasm-bindgen"}}),Z=new O({props:{type:5,title:"Why Rust?"}}),tt=new O({props:{type:5,title:"Why WebAssembly?"}}),et=new O({props:{type:5,title:"Series"}}),rt=new O({props:{type:5,title:"DataFrame"}}),ct=new ws({}),{c(){v(D.$$.fragment),Bt=i(),z=s("main"),ht=s("header"),v(J.$$.fragment),Ut=i(),d=s("main"),k=s("div"),v(C.$$.fragment),Xt=i(),Mt=s("h4"),Yt=c("Fast, Series and DataFrames powered by WebAssembly and Rust."),Zt=i(),dt=s("h5"),te=c("5th May 2022 ~ Dion Pinto"),ee=i(),m=s("div"),Nt=s("div"),H=s("a"),ae=c("Introduction"),se=i(),xt=s("div"),V=s("a"),ne=c("What is ml-wasm/entropy"),re=i(),Ft=s("div"),j=s("a"),ie=c("Why Ndarray"),oe=i(),Jt=s("div"),q=s("a"),le=c("What is wasm-bindgen"),ce=i(),Ct=s("div"),B=s("a"),he=c("Why Rust"),de=i(),Ht=s("div"),L=s("a"),me=c("Why WebAssembly"),ue=i(),Vt=s("div"),G=s("a"),pe=c("Series"),we=i(),jt=s("div"),K=s("a"),fe=c("Dataframe"),ge=i(),T=s("section"),v(Q.$$.fragment),ve=i(),mt=s("p"),ye=c(`Machine learning is an integral part of society. A fundamental cog in the machine learning
